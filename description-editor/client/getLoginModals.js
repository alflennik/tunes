  ...
  getModal({
    ...
    getBody: parentNode => {
      parentNode.innerHTML = /* HTML */ `
        ...
        <button already-signed-in type="button" class="already-signed-in-button">
          Already signed in?
        </button>
      `

      const signInWithGitHubElement = parentNode.querySelector("[sign-in-with-github]")
      const alreadySignedInElement = parentNode.querySelector("[already-signed-in]")
